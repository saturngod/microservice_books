...
### CAP Theorem
CAP Theorem (Brewer's Theorem) သည် distributed system တစ်ခုတွင် network partition ဖြစ်နေသောအချိန်၌ Consistency နှင့် Availability နှစ်ခုစလုံးကို တပြိုင်နက် အပြည့်အဝ မရနိုင်ကြောင်း ရှင်းပြသည်။ ထို့ကြောင့် practical distributed systems များသည် Partition Tolerance ကို လက်ခံပြီး partition အခြေအနေတွင် C သို့မဟုတ် A ကို ဘယ်ဘက်ပိုဦးစားပေးမည်ကို ဆုံးဖြတ်ရသည်။ CP systems များသည် data correctness ကို ဦးစားပေးပြီး AP systems များသည် availability ကို ဦးစားပေးသည်။
...
Eventual Consistency သည် distributed system တွင် new writes ပြီးနောက် data ကို reads ဖြင့် ချက်ချင်းမမြင်ရနိုင်ဘဲ — network partition မဖြစ်ဘဲ လုံလောက်သောအချိန်ကြာပြီးနောက် replicas အားလုံးသည် same value သို့ converge မည်ကို guarantee ပေးသော consistency model ဖြစ်သည်။ Strong consistency ထက် lower latency နှင့် higher availability ကို ရသော်လည်း stale reads ဖြစ်နိုင်သည်ကို accept ပြုရသည်။ Cassandra နှင့် DNS ကဲ့သို့ systems များတွင် common ဖြစ်ပြီး cloud products အချို့တွင် configuration သို့မဟုတ် service version ပေါ်မူတည်၍ strong consistency သို့ ပြောင်းလဲထားနိုင်သည်။
